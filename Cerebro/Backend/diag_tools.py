...
CASOS: list[tuple[str, list[str]]] = [
    ...
    ("¿me sacudiste o detectaste algún movimiento?", ["leer_gesto"]),
    ("¿hacia qué dirección apunta la brújula?", ["leer_brujula"]),
    ("¿estoy tocando el logo de la plaquita?", ["leer_toque"]),
