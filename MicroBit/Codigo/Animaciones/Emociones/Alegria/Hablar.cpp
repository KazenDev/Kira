 ...
 *
 * Lo activa la IA con "TALK". Otra emocion -> detenerHablar() apaga
 * modoHablar y la fibra muere sola en su siguiente ciclo.
 */
#include "Hablar.h"
#include "Alegria.h"
...
// Checa modoHablar en cada paso: si llega otra emocion, la fibra
