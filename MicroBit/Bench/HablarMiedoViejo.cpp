/**
 * HablarMiedoViejo.cpp - la version ANTERIOR de la boca de Miedo (git show),
 * solo para el bench. Usa el modoHablar real, como en la firmware.
