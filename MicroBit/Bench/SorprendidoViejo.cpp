/**
 * SorprendidoViejo.cpp - la version ANTERIOR (git show), solo para el bench.
...
// ---------------------------------------------------------------------------
void mostrarCaraSorprendidoVieja()   // publica: el primer frame (para las transiciones)
{
