/**
 * AlegriaVieja.cpp - LA VERSION ANTERIOR, solo para el bench.
 * Extraida con git show del commit anterior al patron de frame. Se le
 * renombraron las funciones para poder linkearse junto a la version nueva.
...
// ---------------------------------------------------------------------------
void mostrarCaraAlegriaVieja()   // publica: el primer frame (para las transiciones)
{
...
// alias interno (la animacion lo usa); la publica es mostrarCaraAlegriaVieja()
static void dibujarCaraBase()
{
    mostrarCaraAlegriaVieja();
}
