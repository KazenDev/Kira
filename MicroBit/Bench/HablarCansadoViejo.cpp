/**
 * HablarCansadoViejo.cpp - la version ANTERIOR de la boca de Cansado (git
 * show), solo para el bench. Usa el modoHablar REAL (como en la firmware,
 * donde todas las bocas comparten el mismo flag). NO se compila en la
 * firmware.
 */
/**
...
void iniciarHablarCansadoVieja()
{
